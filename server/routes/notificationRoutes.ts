...
import { notificationController } from "../app";
 ...
 export const notificationRoutes = () => {
    ...
    notificationRoutes.delete('/:notificationId', notificationController.toggleDelete);
    notificationRoutes.delete('/receiver/:notificationId', notificationController.toggleReceiverDelete);
