      ...
      case 1:
        return (
          <>
            <span
              className={cx(
                classes.personsComponent,
                classes.personsSingleComponent
              )}
              style={{
          ...
          <>
            {itemPersonsIds.map((id, index) => {
              return (
                <span
                  ...
                  className={
                    index
                      ? cx(
                          classes.personsComponent,
                          classes.personsSecondComponent
                        )
                      : cx(
                          classes.personsComponent,
                          classes.personsFirstComponent
                        )
                  }
                  style={{
                ...
                >
                  {membersFullName[id] &&
                    (membersFullName[id].firstName &&
                    membersFullName[id].lastName
        ...
        return (
          <>
            ...
            <span
              ...
              className={cx(
                classes.personsComponent,
                classes.personsMultipleComponent
              )}
        ...
        <span className={classes.personsPopUpContainer}>
                  ...
                  >
                    ...
                    <span className={classes.iconX}>
                      <IconX
                        size={15}
                        onClick={() =>
                          onRemovePerson(groupId, itemId, typeId, id)
                        }
                      />
                    </span>
                  </span>
          ...
          <span className={classes.suggestionList}>
            {Object.keys(membersFullName).map((key) => {
              ...
              if (
                !itemPersonsIds.includes(memberId) &&
                membersFullName[memberId]
              ) {
                ...
                return (
                  <span
                    ...
                    onClick={() =>
                      onAddPerson(groupId, itemId, typeId, memberId)
                    }
                  >
                    <span className={classes.iconUser}>
                      <IconUserCircle />
