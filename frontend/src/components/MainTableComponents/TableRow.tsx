...
export function TableRow({
  ...
  const retrieveCellData = (
    cell: itemCellsElement,
    cellIndex: number
  ): JSX.Element => {
    switch (cell.type_name) {
      ...
      case "times":
        return (
          ...
          >
            <Times
              startDate={cell.item_times_start_date}
              endDate={cell.item_times_end_date}
            />
          </div>
        );
      case "status":
  ...
  return (
    ...
    >
      ...
      <Modal
        ...
        title={
          <span className={classes.modalTitle}>{"Delete this item?"}</span>
        }
        centered
      >
