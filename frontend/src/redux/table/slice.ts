...
const getTable: CaseReducer<
  CombinedTableState,
  PayloadAction<TableStateArray>
> = (state, action) => {
...
const getFavorite: CaseReducer<
  CombinedTableState,
  PayloadAction<MyFavoriteListState>
> = (state, action) => {
  state.my_favorite_list = action.payload;
};
const getTableList: CaseReducer<
  CombinedTableState,
  PayloadAction<MyTableListState>
> = (state, action) => {
  state.project_list = action.payload;
};
const getStatusList: CaseReducer<
  CombinedTableState,
  PayloadAction<StatusListStateArray>
> = (state, action) => {
  state.status_list = action.payload;
};
const updateTableList: CaseReducer<
  CombinedTableState,
  PayloadAction<MyTableState>
> = (state, action) => {
...
const addProject: CaseReducer<
  CombinedTableState,
  PayloadAction<MyTableState>
> = (state, action) => {
  state.project_list.push(action.payload);
};
const addStatus: CaseReducer<
  CombinedTableState,
  PayloadAction<StatusListState>
> = (state, action) => {
